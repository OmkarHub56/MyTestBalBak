...
public class InviteAdapter extends RecyclerView.Adapter<MyInviteViewholder> {
    ...
    public InviteAdapter(List<MyUsers> list,Context context){
    ...
    @NonNull
    @Override
    public MyInviteViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.i("b","times");
        View view= LayoutInflater.from(context).inflate(R.layout.one_user_layout_invite,parent,false);
        return new MyInviteViewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyInviteViewholder holder, @SuppressLint("RecyclerView") int position) {
...
class MyInviteViewholder extends RecyclerView.ViewHolder{

    ImageView image;
    TextView userName;
    //    View itemView;
    CircleImageView acceptReqBtn,rejectReqBtn;
    public MyInviteViewholder(@NonNull View itemView) {
        super(itemView);
